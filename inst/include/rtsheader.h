...
using returns = std::variant<int, double, Eigen::VectorXd, Eigen::MatrixXd, std::vector<double>, std::vector<std::string>, 
    VectorMatrix, MatrixMatrix, std::pair<double, double> >;
