...
#include "stanExports_approxlgcp_nngp_region.h"

RCPP_MODULE(stan_fit4approxlgcp_nngp_region_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_approxlgcp_nngp_region")
