...
#include "stanExports_lgcp_region.h"

RCPP_MODULE(stan_fit4lgcp_region_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_lgcp_region")
