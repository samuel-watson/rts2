...
class model_approxlgcp_nngp_region final : public model_base_crtp<model_approxlgcp_nngp_region> {
private:
  int D;
  int Q;
  int Q_g;
...
public:
  ...
  inline std::string model_name() const final { return "model_approxlgcp_nngp_region"; }
  ...
  model_approxlgcp_nngp_region(stan::io::var_context& context__,
    ...
    try {
      ...
      current_statement__ = 152;
      validate_non_negative_index("region_mean_predict", "Nsample * nT",
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_approxlgcp_nngp_region_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      check_greater_or_equal(function__, "sigma", sigma, 1e-05);
      {
        ...
        validate_non_negative_index("region_mean", "Nsample * nT",
                                    (Nsample * nT));
        Eigen::Matrix<local_scalar_t__, -1, 1> region_mean;
        region_mean = Eigen::Matrix<local_scalar_t__, -1, 1>((Nsample * nT));
        ...
        if (logical_gt(nT, 1)) {
          ...
          lp_accum__.add(normal_lpdf<propto__>(ar[(1 - 1)], 0, 1));
        } 
        ...
        if (logical_gt(Q_g, 0)) {
          ...
          assign(region_mean, nil_index_list(), multiply(X_g, gamma_g),
            "assigning variable region_mean");
        } 
        ...
        for (int r = 1; r <= n_region; ++r) {
          ...
          for (int t = 1; t <= nT; ++t) {
              ...
              (popdens[((r + ((t - 1) * n_region)) - 1)] *
                stan::math::exp(
                  multiply(
                    ...
                    gamma))), "assigning variable lambda_r");
                        ...
                        (q_weights[(((n_cell[(r - 1)] + l) - 1) - 1)] *
                          stan::math::exp(
                            (f[((cell_id[(((n_cell[(r - 1)] + l) - 1) - 1)] +
                                  ((t - 1) * Nsample)) - 1)] +
                              region_mean[((cell_id[(((n_cell[(r - 1)] + l) -
                                                       1) - 1)] +
                                             ((t - 1) * Nsample)) - 1)]))));}
            ...
            assign(lambda_r,
              cons_list(index_uni((r + ((t - 1) * n_region))),
                nil_index_list()),
              (lambda_r[((r + ((t - 1) * n_region)) - 1)] * accum),
              "assigning variable lambda_r");}}
...
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      region_mean_predict = Eigen::Matrix<double, -1, 1>(region_mean_predict_1dim__);
      stan::math::fill(region_mean_predict, std::numeric_limits<double>::quiet_NaN());
      ...
      if (logical_gt(Q_g, 0)) {
        ...
        assign(region_mean_predict, nil_index_list(), multiply(X_g, gamma_g),
          "assigning variable region_mean_predict");
      } 
              ...
              (region_predict[((r + ((t - 1) * n_region)) - 1)] +
                (((popdens[((r + ((t - 1) * n_region)) - 1)] *
                  ...
                  stan::math::exp(
                    (f[((cell_id[(((n_cell[(r - 1)] + l) - 1) - 1)] +
                          ((t - 1) * Nsample)) - 1)] +
                      region_mean_predict[((cell_id[(((n_cell[(r - 1)] + l) -
                                                       1) - 1)] +
                                             ((t - 1) * Nsample)) - 1)])))),
      ...
      for (int sym1__ = 1; sym1__ <= region_mean_predict_1dim__; ++sym1__) {
        vars__.emplace_back(region_mean_predict[(sym1__ - 1)]);}
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
      throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***"); 
  ...
  inline void get_param_names(std::vector<std::string>& names__) const {
    ...
    names__.emplace_back("region_mean_predict");
    } // get_param_names() 
  ...
  inline void get_dims(std::vector<std::vector<size_t>>& dimss__) const {
    ...
    dimss__.emplace_back(std::vector<size_t>{
                                             static_cast<size_t>(region_mean_predict_1dim__)
                                             });
  ...
  inline void constrained_param_names(
    ...
    if (emit_generated_quantities__) {
      ...
      for (int sym1__ = 1; sym1__ <= region_mean_predict_1dim__; ++sym1__) {
        {
          param_names__.emplace_back(std::string() + "region_mean_predict" + '.' + std::to_string(sym1__));
        }}
    }
...
using stan_model = model_approxlgcp_nngp_region_namespace::model_approxlgcp_nngp_region;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_approxlgcp_nngp_region_namespace::profiles__;
}
#endif
#endif
