...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(15, 13, "end", "model_mcml_poisson");
    return reader;
}
#include <stan_meta_header.hpp>
class model_mcml_poisson
  : public stan::model::model_base_crtp<model_mcml_poisson> {
private:
        int N;
        vector_d Xb;
        matrix_d Z;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            validate_non_negative_index("Z", "N", N);
            context__.validate_dims("data initialization", "Z", "matrix_d", context__.to_vec(N,N));
            Z = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(N, N);
            vals_r__ = context__.vals_r("Z");
            pos__ = 0;
            size_t Z_j_2_max__ = N;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("gamma", "N", N);
        context__.validate_dims("parameter initialization", "gamma", "vector_d", context__.to_vec(N));
        Eigen::Matrix<double, Eigen::Dynamic, 1> gamma(N);
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                gamma = in__.vector_constrain(N, lp__);
            else
                gamma = in__.vector_constrain(N);
            // model body
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> gamma = in__.vector_constrain(N);
        size_t gamma_j_1_max__ = N;
        for (size_t j_1__ = 0; j_1__ < gamma_j_1_max__; ++j_1__) {
...
typedef model_mcml_poisson_namespace::model_mcml_poisson stan_model;
#ifndef USING_R
